...
namespace Projeto_TAREFA.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Login([Bind(Include = "ID,Login,Senha")] Usuario Usuario)
        {
            Usuario usuario = db.Usuario.Where(x => x.Login == Usuario.Login && x.Senha == Usuario.Senha).FirstOrDefault();
